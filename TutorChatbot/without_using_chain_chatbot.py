...
while True:
    ...
    prompt = template.format_messages(chat_history=chat_history, formatting_instructions = instructions)
    res = model.invoke(prompt)
    chat_history.append(AIMessage(content=res)) # res is a string here
    print(f'AI: {res}')
